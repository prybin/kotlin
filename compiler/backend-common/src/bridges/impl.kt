...
private data class DescriptorBasedFunctionHandle(val descriptor: FunctionDescriptor) : FunctionHandle {
    ...
    // SynthesizedCallableMemberDescriptor check is here for SAM adapters
    // TODO: test bridges for SAM adapters/constructors
    override val isAbstract: Boolean =
            descriptor.getModality() == Modality.ABSTRACT ||
            (DescriptorUtils.isTrait(descriptor.getContainingDeclaration()) && descriptor !is SynthesizedCallableMemberDescriptor<*>)
