...
public class TaskPrioritizer {
    ...
    public static <D extends CallableDescriptor, F extends D> List<ResolutionTask<D, F>> computePrioritizedTasks(
            ...
            @NotNull CallableDescriptorCollectors<? extends D> callableDescriptorCollectors
    ) {
    ...
    private static <D extends CallableDescriptor, F extends D> void addCandidatesForExplicitReceiver(
        ...
        //members
        for (CallableDescriptorCollector<? extends D> callableDescriptorCollector : c.callableDescriptorCollectors.getCollectors()) {
    ...
    private static class TaskPrioritizerContext<D extends CallableDescriptor, F extends D> {
        ...
        @NotNull public final CallableDescriptorCollectors<? extends D> callableDescriptorCollectors;
