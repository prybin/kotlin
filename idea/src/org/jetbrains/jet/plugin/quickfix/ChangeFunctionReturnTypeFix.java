    ...
    public static JetSingleIntentionActionFactory createFactoryForComponentFunctionReturnTypeMismatch() {
        return new JetSingleIntentionActionFactory() {
            ...
            public IntentionAction createAction(Diagnostic diagnostic) {
                ...
                BindingContext context = AnalyzerFacadeWithCache.analyzeFileWithCache(entry.getContainingFile()).getBindingContext();
    ...
    public static JetSingleIntentionActionFactory createFactoryForHasNextFunctionTypeMismatch() {
        return new JetSingleIntentionActionFactory() {
            ...
            public IntentionAction createAction(Diagnostic diagnostic) {
                ...
                BindingContext context = AnalyzerFacadeWithCache.analyzeFileWithCache(expression.getContainingFile()).getBindingContext();
